...
class LoggerUnitTest():
    def __init__(self,inst,AD,file_name,count_thresh,flow):
        ...
        # Set this to true to update the configure
        self.conf = False 
        ...
        # The list of function descriptors used by the application.
        self.fd =None 

    def __str__(self):
        return "LoggerUnit: " + self.file_name + " treshhold: " + str(self.count_thresh) + " Logging Flows: " + str(self.flow)
    ...
    def init(self):
        ...
        fd = self.cntxt.apply_elem(self.app_d, self.flow,
                                  "Logger", parameters, self) 
